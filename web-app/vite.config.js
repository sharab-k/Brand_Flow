  ...
  build: {
    rollupOptions: {
      input: {
        ...
        briefs_invited: resolve(__dirname, 'briefs-invited.html'),
        ...
        create_new_password: resolve(__dirname, 'create-new-password.html'),
        otp_verification: resolve(__dirname, 'otp-verification.html'),
        password_successful: resolve(__dirname, 'password-successful.html'),
        ...
        setting_organization_info: resolve(__dirname, 'setting-organization-info.html'),
        setting_security: resolve(__dirname, 'setting-security.html'),
