            ...
            <div className="bg-blue-50 rounded-xl p-6 mb-8 border border-blue-100">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <h2 className="text-2xl font-bold text-slate-900">Pro Plan</h2>
                  <p className="text-sm text-slate-600 mt-1">€49/month • Next billing date: Feb 28, 2026</p>
                </div>
                <span className="bg-blue-600 text-white text-xs px-3 py-1 rounded-full font-bold">Active</span>
              </div>
            </div>
            {/* Payment Method */}
            <div className="mb-8">
              ...
              <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                <div className="flex items-center gap-4">
                  <div className="h-10 w-16 bg-gray-100 rounded flex items-center justify-center text-xs font-bold text-slate-500">VISA</div>
                  <div>
              ...
              <div className="overflow-hidden border border-gray-200 rounded-lg">
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {[{ date: 'Jan 28, 2026', amount: '€49.00' }, { date: 'Dec 28, 2025', amount: '€49.00' }].map((row, i) => (
                      <tr key={i}>
