...
const initialConversations = [
  ...
  { id: 2, name: 'Nova Apparel Industries', avatar: 'NA', ref: '#BR12345678', date: '18/01/2024', lastMessage: 'Yes, customization is available with a 20-day...', unread: 0, subject: 'RE: Custom Apparel Order', messages: [{ id: 1, text: 'Hi, we received your brief. Can we discuss customization options?', sender: 'them', time: '14:20' }, { id: 2, text: 'Yes, customization is available with a 20-day lead time.', sender: 'them', time: '15:00' }] },
  { id: 3, name: 'BlueWeave Garments', avatar: 'BG', ref: '#BR12345678', date: '12/01/2024', lastMessage: "We've reviewed your brief and sent a quo...", unread: 0, subject: 'RE: Garment Manufacturing Quote', messages: [{ id: 1, text: "We've reviewed your brief and sent a quotation to your email.", sender: 'them', time: '11:30' }] },
  { id: 4, name: 'Prime Stitch Solutions', avatar: 'PS', ref: '#BR12345678', date: '10/01/2024', lastMessage: 'MOQ starts at 300 units for this material...', unread: 1, subject: 'RE: Material Sourcing', messages: [{ id: 1, text: 'MOQ starts at 300 units for this material. Would you like to proceed?', sender: 'them', time: '09:45' }] },
  { id: 5, name: 'Urban Loom Factory', avatar: 'UF', ref: '#BR12345678', date: '08/01/2024', lastMessage: 'Production can begin once design approval is...', unread: 0, subject: 'RE: Production Timeline', messages: [{ id: 1, text: 'Production can begin once design approval is finalized. Please confirm.', sender: 'them', time: '16:10' }] },
]
...
export default function Messages() {
  ...
  const sendMessage = () => {
    ...
    setConversations(prev => prev.map(c => c.id === activeChat ? {
      ...c,
      messages: [...c.messages, { id: Date.now(), text: newMessage, sender: 'me', time: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }) }],
      lastMessage: newMessage, date: 'Now'
    } : c))
    setNewMessage('')
  }
  ...
  return (
    <div className="bg-white text-slate-800 antialiased font-sans flex flex-col h-screen">
      ...
      <main className="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-4 w-full flex flex-col h-[calc(100vh-64px)]">
          ...
          <div className={`w-full md:w-1/3 bg-white rounded-xl border border-gray-100 flex-col h-full shadow-sm ${showMobileChat ? 'hidden md:flex' : 'flex'}`}>
            <div className="px-5 pt-5 pb-0 border-b border-gray-100 bg-white">
              ...
              <div className="flex gap-6 relative">
                <button className="pb-2.5 px-0.5 text-[13px] font-bold text-blue-600 border-b-2 border-blue-600">All(10)</button>
                <button className="pb-2.5 px-0.5 text-[13px] font-medium text-slate-500 hover:text-slate-800 transition-colors">Unread (3)</button>
              </div>
            </div>
