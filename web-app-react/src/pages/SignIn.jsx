          ...
          <form action="/" className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <input type={showPassword ? 'text' : 'password'} id="password" defaultValue="password123"
                  className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all text-sm tracking-widest text-slate-800 font-serif" />
            ...
            <button type="button" onClick={() => navigate('/dashboard')}
              className="w-full bg-[#4082ED] hover:bg-blue-600 text-white font-medium py-3 rounded-lg transition-all text-[15px] mt-2 h-[46px]">Sign In</button>
          </form>
